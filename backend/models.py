...
class Product(Base):
    ...
    # 'fertilizer', 'pesticide', 'seed', 'equipment'
...
class Pesticide(Product):
    ...
    pesticide_type = Column(String(50))
...
class Seed(Product):
    ...
    # e.g., "hybrid", "open-pollinated", "heirloom"
    seed_type = Column(String(50))
    ...
    # e.g., "full sun", "partial shade"
    sunlight_requirement = Column(String(50))
...
class Equipment(Product):
    ...
    # e.g., "irrigation", "harvesting", "planting"
    ...
    # e.g., "100W" (for electric equipment)
